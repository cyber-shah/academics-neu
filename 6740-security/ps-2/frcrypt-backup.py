...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--decrypt", action="store_tmitives.asymmetric.padding.OAEP(
                mgf=primitives.asymmetric.padding.MGF1(
                    algorithm=primitives.hashes.SHA256()
                ),
                algorithm=primitives.hashes.SHA256(),
    ...
    def decrypt_ciphertext(self, symmetric_key, in_ciphertext):
      ...
      tric_key = self.decrypt_symmetric_key(encrypted_symmetric_key,
                                                        self.dest_SK)
    ...
    def decrypt(self, out_file):
        ...
        self.symmeignature = self.sign_plaintext(self.sender_SK, self.in_file)
    ...
    def encrypt(self, out_file):
        ...
        shis padding is typically derived from the number of empty spaces
    ...
    def encrypt_plaintext(self, symmetric_key, in_plaintext):
        ...
        cipher = ciphers.Cipher(
            ...
            ciphers.modes.CBC(iv  salt=salt,
            iterations=100000,
    ...
    def encrypt_symmetric_key(self, symmetric_key, dest_PK):
        ...
        return dest_PK.encrypt(
            ...
            primitives.asymmetric.padding.OAEP(
                mgf=primitives.asymmetric.padding.          with open(in_file, 'rb') as f:
